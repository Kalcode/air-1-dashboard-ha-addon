...
export const Delta: Component<DeltaProps> = (props) => {
  const result = () => {
    ...
    const c = Number.parseFloat(props.current);
    const p = Number.parseFloat(props.previous);
          ...
          <div style={{ 'margin-bottom': '2px' }}>
            ...
            >
              ...
              >
                ...
                <span style={{ color: '#64748b', 'font-size': '11px', ...mono }}>{props.unit}</span>
              </div>
            </div>
            <div
              style={{
            ...
            <Delta current={props.value} previous={props.prevValue} metric={props.thresholdKey} />
          </div>
        );
      }}
    </Show>
      ...
      {(quality) => {
        ...
        return (
          ...
          >
            ...
            <Show when={hint()}>
              <span style={{ 'font-size': '10px', ...mono, color: '#475569' }}>{hint()}</span>
            </Show>
          </div>
        );
      }}
